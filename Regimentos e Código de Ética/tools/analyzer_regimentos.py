...
ARQUIVO_ENTRADA = "dataset_regimentos_final.json"
ARQUIVO_APROVADO = "dataset_regimentos_aprovado.json"
ARQUIVO_REVISAO = "dataset_regimentos_revisao.json"
