...
ARQUIVO_ENTRADA = "dataset_governanca_final.json"
ARQUIVO_APROVADO = "dataset_governanca_aprovado.json"
ARQUIVO_REVISAO = "dataset_governanca_revisao.json"
